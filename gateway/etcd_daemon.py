...
if __name__ == "__main__":
    ...
    daemon_logger.info("Gateway etcd_daemon program started.")
    ...
    if "cluster" in config["etcd"] and \
        ...
        try:
            ...
            daemon_logger.error("Gateway etcd_daemon program exiting.")
            exit(1)
        ...
        if services:
            ...
            daemon_logger.info("Gateway etcd_daemon program exiting.")
            exit(1)
